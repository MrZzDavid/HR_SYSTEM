                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($row['PositionTitle'] ?? ''); ?></td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#careerHistoryTable').DataTable({
                ...
                columnDefs: [{
                    orderable: false,
                    targets: 0 // Disable sorting on action column
                }],
                dom: '<"top d-flex align-items-center justify-content-between mb-3"lf>rt<"bottom d-flex align-items-center justify-content-between mt-3"ip>',
                initComplete: function() {
                    // Add Bootstrap class to the select
                    $('#careerHistoryTable_length select').addClass('form-select form-select-sm');
                }
            });
