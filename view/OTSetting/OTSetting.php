...
<div class="modal fade" id="editOTSettingModal" tabindex="-1" aria-labelledby="editOTSettingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary text-white border-0">
                <h5 class="modal-title" id="editOTSettingModalLabel">
                    <i class="fas fa-edit me-2"></i>Edit OT Setting
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4">
                <form id="editOTSettingForm" class="needs-validation" novalidate>
                    <div class="mb-4">
                        <label for="edit_ot_code" class="form-label fw-semibold">Code</label>
                        <input type="text" class="form-control" id="edit_ot_code" readonly>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label for="edit_rate" class="form-label fw-semibold">Rate</label>
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button type="button" class="btn btn-primary fw-semibold" id="updateOTSetting">Save Changes</button>
            </div>
        </div>
    </div>
</div>
